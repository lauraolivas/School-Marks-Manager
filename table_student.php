...
<html lang="en">
  ...
  <head>
    ...
    <title>School Marks Manager - Table students</title>
    ...
    if(!empty($_SESSION['user']) && ($_SESSION['type']=='teacher'||$_SESSION['type']=='root')){
      ...
      $theader='<thead>
                  <tr>
                    <th>Edit</th>
                    <th>Delete</th>
                    <th><a href="table_student.php?sort=u">User</a></th>
                    <th><a href="table_student.php?sort=fn">First name</th>
                    <th><a href="table_student.php?sort=ln">Last name</th>
                    <th><a href="table_student.php?sort=p">Phone</th>
                    <th><a href="table_student.php?sort=e">Email</th>
      ...
      while ($numrecs = mysqli_fetch_array ($tabler, MYSQLI_ASSOC)) {
          $tbody = $tbody.'<tr>
          <td><a href="edit_student.php?user=' . $numrecs['user'] . '">Edit</a></td>
          <td><a href="delete_student.php?user=' . $numrecs['user'] . '">Delete</a></td>
          <td>' . $numrecs['user'] . '</td>
