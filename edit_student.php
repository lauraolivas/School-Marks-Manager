...
<html lang="en">
  ...
  <head>
    ...
    <title>School Marks Manager - Edit student</title>
            ...
            <div class="card card-register mx-auto mt-5">
              ...
              <div class="card-body">
                <div class="text-center">
                  <p>You must choose a student</p>
                  <a href="modifier_delete_student.php" class="d-block small mt-3">Back to the class list</a>
                </div>
              </div>
            </div>
          </div>';
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(!empty($_POST['inputPassword'])&&empty($_POST['confirmPassword'])){
          ...
          if (mysqli_affected_rows($dbc) == 1) { 
            $update='<a href="modifier_delete_student.php" class="d-block small mt-3">Back to the class list</a>';
          } else { 
