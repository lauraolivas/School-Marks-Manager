      ...
      for($i=0;$i<count($sid);$i++){
        ...
        if(!empty($_GET['subject'])){
          ...
          if (isset($_GET['p']) && is_numeric($_GET['p'])) { 
            ...
            $pagq = "SELECT COUNT(u.user) FROM users as u inner join subjects_users as su WHERE su.subjectid='$subject' and u.type='student'";
          ...
          $qusers="SELECT u.firstname,u.lastname,u.email,u.phone from subjects_users as su inner join users as u on su.user=u.user where su.subjectid='ASO' and u.type='student' order by $order_by limit $start,$display";
          $rusers=$ir = @mysqli_query ($dbc, $qusers);
          $theader='<thead>
                  <tr>
