...
<html lang="en">
  ...
  <head>
    ...
    <title>School Marks Manager - Subjects students</title>
  ...
  <body id="page-top">
    ...
    if(!empty($_SESSION['user'])&&$_SESSION['type']=='root'){
      ...
      $iq = "SELECT user, subjectid FROM subjects_users";
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link 
           <?php if(!empty($dropdown)){echo "dropdown-toggle";} ?>
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <?php
              if(!empty($dropdown)){
                ...
                echo '<a class="dropdown-item" href="There are not users in the subject">Login</a>
                <div class="dropdown-divider"></div>';
              }
            ?>
          </div>
